...
class RoutineSequencer:
    def __init__(self, *routines: Routine[HCMachineAction, np.ndarray, Any], n_actions: int = 8) -> None:
        self.routines = routines
        self.n_actions = n_actions
        
    def get_outputs(self, actions: dict[Hashable, HCMachineAction], state: GameState, shared_info: dict[str, Any]) -> dict[Hashable, np.ndarray]:
